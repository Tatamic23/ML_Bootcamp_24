# -*- coding: utf-8 -*-
"""Sentimental analytics.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1uVCbN6E0swa9a3jfEQMdi5u8zKI5v5DK
"""
...
ax = df['Score'].value_counts().sort_index().plot(kind = 'bar', title = 'Count of Reviews by Stars',figsize= (10,5), color ='lightblue')
...
sia.polarity_scores('I hate you but i like your pretty purse')
...
sns.barplot(data = vaders, x = 'Score', y = 'pos',ax = axs[0],color = 'purple')
sns.barplot(data = vaders, x = 'Score', y = 'neu',ax = axs[1])
sns.barplot(data = vaders, x = 'Score', y = 'neg',ax = axs[2],color = 'grey')
